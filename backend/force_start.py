...
# On force un fichier de base de données local unique pour être sûr
...
def start_force():
    with app.app_context():
        ...
        agent = Agent(
            ...
            phone="0000",
            # On crypte le mot de passe "0000"
    ...
    # On lance le serveur sur toutes les interfaces (0.0.0.0)
